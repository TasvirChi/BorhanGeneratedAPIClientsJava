...
import com.borhan.client.enums.BorhanAdType;
...
public class BorhanAdCuePoint extends BorhanCuePoint {
    public BorhanAdProtocolType protocolType;
    public String sourceUrl;
    public BorhanAdType adType;
    public String title;
    public int endTime = Integer.MIN_VALUE;
	/**  Duration in milliseconds     */
    public int duration = Integer.MIN_VALUE;

    public BorhanAdCuePoint() {
    }

    public BorhanAdCuePoint(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("protocolType")) {
                this.protocolType = BorhanAdProtocolType.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("sourceUrl")) {
                this.sourceUrl = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("adType")) {
                this.adType = BorhanAdType.get(ParseUtils.parseString(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanAdCuePoint");

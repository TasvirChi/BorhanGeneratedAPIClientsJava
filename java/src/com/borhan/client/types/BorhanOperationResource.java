...
public class BorhanOperationResource extends BorhanContentResource {
	/**  Only BorhanEntryResource and BorhanAssetResource are supported     */
    public BorhanContentResource resource;
    ...
    public BorhanOperationResource() {
    }

    public BorhanOperationResource(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("resource")) {
                this.resource = ParseUtils.parseObject(BorhanContentResource.class, aNode);
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanOperationResource");

...
public abstract class BorhanScheduledTaskProfileBaseFilter extends BorhanFilter {
    ...
    public BorhanScheduledTaskProfileStatus statusEqual;
    ...
    public BorhanScheduledTaskProfileBaseFilter() {
    }

    public BorhanScheduledTaskProfileBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = BorhanScheduledTaskProfileStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanScheduledTaskProfileBaseFilter");

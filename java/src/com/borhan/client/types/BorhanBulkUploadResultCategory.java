...
public class BorhanBulkUploadResultCategory extends BorhanBulkUploadResult {
    ...
    public BorhanBulkUploadResultCategory() {
    }

    public BorhanBulkUploadResultCategory(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanBulkUploadResultCategory");

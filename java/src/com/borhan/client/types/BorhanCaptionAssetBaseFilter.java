...
import com.borhan.client.enums.BorhanCaptionAssetStatus;
...
public abstract class BorhanCaptionAssetBaseFilter extends BorhanAssetFilter {
    public int captionParamsIdEqual = Integer.MIN_VALUE;
    public String captionParamsIdIn;
    public BorhanCaptionType formatEqual;
    public String formatIn;
    public BorhanCaptionAssetStatus statusEqual;
    public String statusIn;
    public String statusNotIn;

    public BorhanCaptionAssetBaseFilter() {
    }

    public BorhanCaptionAssetBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("captionParamsIdEqual")) {
                ...
                this.formatEqual = BorhanCaptionType.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("formatIn")) {
                this.formatIn = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("statusEqual")) {
                this.statusEqual = BorhanCaptionAssetStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanCaptionAssetBaseFilter");

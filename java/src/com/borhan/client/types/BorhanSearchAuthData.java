...
public class BorhanSearchAuthData extends BorhanObjectBase {
    ...
    public BorhanSearchAuthData() {
    }

    public BorhanSearchAuthData(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanSearchAuthData");

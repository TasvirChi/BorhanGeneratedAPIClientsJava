...
public class BorhanReportTable extends BorhanObjectBase {
    public String header;
    public String data;
    public int totalCount = Integer.MIN_VALUE;

    public BorhanReportTable() {
    }

    public BorhanReportTable(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanReportTable");
        return kparams;
    }

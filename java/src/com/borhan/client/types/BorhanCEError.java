...
public class BorhanCEError extends BorhanObjectBase {
    public String id;
    ...
    public BorhanCEError() {
    }

    public BorhanCEError(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanCEError");

...
public abstract class BorhanVirusScanProfileBaseFilter extends BorhanFilter {
    ...
    public BorhanVirusScanProfileStatus statusEqual;
    public String statusIn;
    public BorhanVirusScanEngineType engineTypeEqual;
    public String engineTypeIn;

    public BorhanVirusScanProfileBaseFilter() {
    }

    public BorhanVirusScanProfileBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = BorhanVirusScanProfileStatus.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("statusIn")) {
                this.statusIn = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("engineTypeEqual")) {
                this.engineTypeEqual = BorhanVirusScanEngineType.get(ParseUtils.parseString(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanVirusScanProfileBaseFilter");

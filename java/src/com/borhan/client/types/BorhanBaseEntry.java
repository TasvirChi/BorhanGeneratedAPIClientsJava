...
public class BorhanBaseEntry extends BorhanObjectBase {
    ...
    public BorhanEntryStatus status;
	/**  Entry moderation status     */
    public BorhanEntryModerationStatus moderationStatus;
	/**  Number of moderation requests waiting for this entry     */
    public int moderationCount = Integer.MIN_VALUE;
	/**  The type of the entry, this is auto filled by the derived entry object     */
    public BorhanEntryType type;
    ...
    public BorhanEntryReplacementStatus replacementStatus;
    ...
    public ArrayList<BorhanOperationAttributes> operationAttributes;
    ...
    public BorhanBaseEntry() {
    }

    public BorhanBaseEntry(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                this.status = BorhanEntryStatus.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("moderationStatus")) {
                this.moderationStatus = BorhanEntryModerationStatus.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("moderationCount")) {
                this.moderationCount = ParseUtils.parseInt(txt);
                continue;
            } else if (nodeName.equals("type")) {
                this.type = BorhanEntryType.get(ParseUtils.parseString(txt));
                continue;
                ...
                this.replacementStatus = BorhanEntryReplacementStatus.get(ParseUtils.parseString(txt));
                continue;
                ...
                this.operationAttributes = ParseUtils.parseArray(BorhanOperationAttributes.class, aNode);
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanBaseEntry");

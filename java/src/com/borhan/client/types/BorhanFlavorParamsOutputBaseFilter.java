...
public abstract class BorhanFlavorParamsOutputBaseFilter extends BorhanFlavorParamsFilter {
    ...
    public BorhanFlavorParamsOutputBaseFilter() {
    }

    public BorhanFlavorParamsOutputBaseFilter(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanFlavorParamsOutputBaseFilter");

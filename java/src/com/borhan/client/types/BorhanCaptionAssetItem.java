...
public class BorhanCaptionAssetItem extends BorhanObjectBase {
	/**  The Caption Asset object     */
    public BorhanCaptionAsset asset;
	/**  The entry object     */
    public BorhanBaseEntry entry;
    public int startTime = Integer.MIN_VALUE;
    public int endTime = Integer.MIN_VALUE;
    public String content;

    public BorhanCaptionAssetItem() {
    }

    public BorhanCaptionAssetItem(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("asset")) {
                this.asset = ParseUtils.parseObject(BorhanCaptionAsset.class, aNode);
                continue;
            } else if (nodeName.equals("entry")) {
                this.entry = ParseUtils.parseObject(BorhanBaseEntry.class, aNode);
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanCaptionAssetItem");

...
public class BorhanDeliveryProfileGenericHds extends BorhanDeliveryProfile {
    public String pattern;
	/**  rendererClass     */
    public String rendererClass;

    public BorhanDeliveryProfileGenericHds() {
    }

    public BorhanDeliveryProfileGenericHds(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanDeliveryProfileGenericHds");

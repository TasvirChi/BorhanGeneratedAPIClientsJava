...
public abstract class BorhanDeliveryProfileBaseFilter extends BorhanFilter {
    ...
    public BorhanPlaybackProtocol streamerTypeEqual;
    public BorhanDeliveryStatus statusEqual;
    public String statusIn;

    public BorhanDeliveryProfileBaseFilter() {
    }

    public BorhanDeliveryProfileBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.streamerTypeEqual = BorhanPlaybackProtocol.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("statusEqual")) {
                this.statusEqual = BorhanDeliveryStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanDeliveryProfileBaseFilter");

...
public class BorhanAnnotation extends BorhanCuePoint {
    ...
    public BorhanAnnotation() {
    }

    public BorhanAnnotation(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanAnnotation");

...
public class BorhanAssetParamsOutput extends BorhanAssetParams {
    ...
    public BorhanAssetParamsOutput() {
    }

    public BorhanAssetParamsOutput(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanAssetParamsOutput");

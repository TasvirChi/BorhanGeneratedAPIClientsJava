...
public class BorhanDropFolderContentProcessorJobData extends BorhanJobData {
    ...
    public BorhanDropFolderContentProcessorJobData() {
    }

    public BorhanDropFolderContentProcessorJobData(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanDropFolderContentProcessorJobData");

...
public class BorhanBulkServiceFilterData extends BorhanBulkServiceData {
	/**  Filter for extracting the objects list to upload      */
    public BorhanFilter filter;
	/**  Template object for new object creation     */
    public BorhanObjectBase templateObject;

    public BorhanBulkServiceFilterData() {
    }

    public BorhanBulkServiceFilterData(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("filter")) {
                ...
                this.templateObject = ParseUtils.parseObject(BorhanObjectBase.class, aNode);
                continue;
            } 
        }
    }
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanBulkServiceFilterData");

...
import com.borhan.client.enums.BorhanEntryModerationStatus;
import com.borhan.client.enums.BorhanEntryType;
import com.borhan.client.enums.BorhanEntryReplacementStatus;
...
public abstract class BorhanBaseEntryBaseFilter extends BorhanFilter {
	...
	/**  This filter should be in use for retrieving only entries which were uploaded
	  by/assigned to users of a specific Borhan Partner (identified by Partner ID).  
	    */
    public int partnerIdEqual = Integer.MIN_VALUE;
	/**  This filter should be in use for retrieving only entries within Borhan network
	  which were uploaded by/assigned to users of few Borhan Partners  (string should
    ...
    public BorhanEntryModerationStatus moderationStatusEqual;
    public BorhanEntryModerationStatus moderationStatusNotEqual;
    public String moderationStatusIn;
    public String moderationStatusNotIn;
    public BorhanEntryType typeEqual;
	...
	/**  This filter parameter should be in use for retrieving only entries which were
	  created at Borhan system after a specific time/date (standard timestamp
	  format).     */
    public int createdAtGreaterThanOrEqual = Integer.MIN_VALUE;
	/**  This filter parameter should be in use for retrieving only entries which were
	  created at Borhan system before a specific time/date (standard timestamp
	  format).     */
    ...
    public BorhanEntryReplacementStatus replacementStatusEqual;
    ...
    public BorhanBaseEntryBaseFilter() {
    }

    public BorhanBaseEntryBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.categoriesIdsEmpty = BorhanNullableBoolean.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("statusEqual")) {
                this.statusEqual = BorhanEntryStatus.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("statusNotEqual")) {
                this.statusNotEqual = BorhanEntryStatus.get(ParseUtils.parseString(txt));
                continue;
                ...
                this.moderationStatusEqual = BorhanEntryModerationStatus.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("moderationStatusNotEqual")) {
                this.moderationStatusNotEqual = BorhanEntryModerationStatus.get(ParseUtils.parseInt(txt));
                continue;
                ...
                this.typeEqual = BorhanEntryType.get(ParseUtils.parseString(txt));
                continue;
                ...
                this.replacementStatusEqual = BorhanEntryReplacementStatus.get(ParseUtils.parseString(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanBaseEntryBaseFilter");

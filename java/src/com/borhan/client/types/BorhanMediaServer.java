...
public class BorhanMediaServer extends BorhanObjectBase {
	/**  Unique identifier     */
    ...
    public BorhanMediaServer() {
    }

    public BorhanMediaServer(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanMediaServer");
        return kparams;
    }

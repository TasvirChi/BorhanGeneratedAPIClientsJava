...
public abstract class BorhanFileAssetBaseFilter extends BorhanFilter {
    public int idEqual = Integer.MIN_VALUE;
    public String idIn;
    public int partnerIdEqual = Integer.MIN_VALUE;
    public BorhanFileAssetObjectType fileAssetObjectTypeEqual;
    ...
    public BorhanFileAssetStatus statusEqual;
    public String statusIn;

    public BorhanFileAssetBaseFilter() {
    }

    public BorhanFileAssetBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.fileAssetObjectTypeEqual = BorhanFileAssetObjectType.get(ParseUtils.parseString(txt));
                continue;
                ...
                this.statusEqual = BorhanFileAssetStatus.get(ParseUtils.parseString(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanFileAssetBaseFilter");

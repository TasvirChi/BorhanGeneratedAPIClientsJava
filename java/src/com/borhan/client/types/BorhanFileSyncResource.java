...
public class BorhanFileSyncResource extends BorhanContentResource {
    ...
    public BorhanFileSyncResource() {
    }

    public BorhanFileSyncResource(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanFileSyncResource");

...
public class BorhanShortLink extends BorhanObjectBase {
    ...
    public BorhanShortLinkStatus status;

    public BorhanShortLink() {
    }

    public BorhanShortLink(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                this.status = BorhanShortLinkStatus.get(ParseUtils.parseInt(txt));
                continue;
            } 
        }
    }
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanShortLink");

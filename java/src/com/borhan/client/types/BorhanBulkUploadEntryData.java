...
public class BorhanBulkUploadEntryData extends BorhanBulkUploadObjectData {
	/**  Selected profile id for all bulk entries        */
    public int conversionProfileId = Integer.MIN_VALUE;

    public BorhanBulkUploadEntryData() {
    }

    public BorhanBulkUploadEntryData(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanBulkUploadEntryData");

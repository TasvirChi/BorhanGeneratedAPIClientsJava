...
import com.borhan.client.enums.BorhanPlaylistType;
...
public class BorhanPlaylist extends BorhanBaseEntry {
    ...
    public BorhanPlaylist() {
    }

    public BorhanPlaylist(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("playlistContent")) {
                ...
                this.filters = ParseUtils.parseArray(BorhanMediaEntryFilterForPlaylist.class, aNode);
                continue;
            } else if (nodeName.equals("totalResults")) {
                this.totalResults = ParseUtils.parseInt(txt);
                continue;
            } else if (nodeName.equals("playlistType")) {
                this.playlistType = BorhanPlaylistType.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanPlaylist");

...
public class BorhanWebcamTokenResource extends BorhanDataCenterContentResource {
	/**  Token that returned from media server such as FMS or red5.     */
    public String token;

    public BorhanWebcamTokenResource() {
    }

    public BorhanWebcamTokenResource(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanWebcamTokenResource");

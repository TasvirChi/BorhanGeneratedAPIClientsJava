...
public abstract class BorhanDistributionProfileBaseFilter extends BorhanFilter {
    ...
    public BorhanDistributionProfileStatus statusEqual;
    public String statusIn;

    public BorhanDistributionProfileBaseFilter() {
    }

    public BorhanDistributionProfileBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = BorhanDistributionProfileStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanDistributionProfileBaseFilter");

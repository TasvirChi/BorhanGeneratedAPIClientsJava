...
public class BorhanConversionProfile extends BorhanObjectBase {
	/**  The id of the Conversion Profile     */
    public int id = Integer.MIN_VALUE;
    public int partnerId = Integer.MIN_VALUE;
    public BorhanConversionProfileStatus status;
    public BorhanConversionProfileType type;
	...
	/**  Cropping dimensions     */
    public BorhanCropDimensions cropDimensions;
    ...
    public BorhanConversionProfile() {
    }

    public BorhanConversionProfile(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                this.status = BorhanConversionProfileStatus.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("type")) {
                this.type = BorhanConversionProfileType.get(ParseUtils.parseString(txt));
                continue;
                ...
                this.cropDimensions = ParseUtils.parseObject(BorhanCropDimensions.class, aNode);
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanConversionProfile");

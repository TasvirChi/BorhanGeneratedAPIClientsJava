...
public class BorhanVarConsolePartnerFilter extends BorhanPartnerFilter {
	/**  Eq filter for the partner's group type        */
    public BorhanPartnerGroupType groupTypeEq;
    ...
    public BorhanVarConsolePartnerFilter() {
    }

    public BorhanVarConsolePartnerFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("groupTypeEq")) {
                this.groupTypeEq = BorhanPartnerGroupType.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanVarConsolePartnerFilter");

...
public class BorhanLiveReportExportJobData extends BorhanJobData {
    ...
    public BorhanLiveReportExportJobData() {
    }

    public BorhanLiveReportExportJobData(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanLiveReportExportJobData");

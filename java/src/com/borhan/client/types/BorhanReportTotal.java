...
public class BorhanReportTotal extends BorhanObjectBase {
    public String header;
    public String data;

    public BorhanReportTotal() {
    }

    public BorhanReportTotal(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanReportTotal");

...
public class BorhanImageFlavorParams extends BorhanFlavorParams {
    ...
    public BorhanImageFlavorParams() {
    }

    public BorhanImageFlavorParams(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanImageFlavorParams");

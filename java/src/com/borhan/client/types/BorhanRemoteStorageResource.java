...
public class BorhanRemoteStorageResource extends BorhanUrlResource {
    ...
    public BorhanRemoteStorageResource() {
    }

    public BorhanRemoteStorageResource(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanRemoteStorageResource");

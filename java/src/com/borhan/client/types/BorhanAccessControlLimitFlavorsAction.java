...
public class BorhanAccessControlLimitFlavorsAction extends BorhanRuleAction {
	/**  Comma separated list of flavor ids      */
    public String flavorParamsIds;
    public boolean isBlockedList;

    public BorhanAccessControlLimitFlavorsAction() {
    }

    public BorhanAccessControlLimitFlavorsAction(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanAccessControlLimitFlavorsAction");

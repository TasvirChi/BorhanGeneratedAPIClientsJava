...
public class BorhanProvisionJobData extends BorhanJobData {
    ...
    public BorhanProvisionJobData() {
    }

    public BorhanProvisionJobData(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanProvisionJobData");

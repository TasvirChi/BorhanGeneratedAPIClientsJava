...
public class BorhanSshImportJobData extends BorhanImportJobData {
    public String privateKey;
    public String publicKey;
    public String passPhrase;

    public BorhanSshImportJobData() {
    }

    public BorhanSshImportJobData(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanSshImportJobData");

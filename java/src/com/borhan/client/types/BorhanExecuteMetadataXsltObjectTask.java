...
public class BorhanExecuteMetadataXsltObjectTask extends BorhanObjectTask {
    ...
    public BorhanExecuteMetadataXsltObjectTask() {
    }

    public BorhanExecuteMetadataXsltObjectTask(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanExecuteMetadataXsltObjectTask");

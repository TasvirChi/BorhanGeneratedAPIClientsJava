...
/**  The BorhanFilterPager object enables paging management to be applied upon
  service list actions.     */
@SuppressWarnings("serial")
public class BorhanFilterPager extends BorhanObjectBase {
    ...
    public BorhanFilterPager() {
    }

    public BorhanFilterPager(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanFilterPager");

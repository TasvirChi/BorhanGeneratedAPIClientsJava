...
import com.borhan.client.enums.BorhanAuditTrailFileSyncType;
...
public class BorhanAuditTrailFileSyncCreateInfo extends BorhanAuditTrailInfo {
    public String version;
    public int objectSubType = Integer.MIN_VALUE;
    public int dc = Integer.MIN_VALUE;
    public boolean original;
    public BorhanAuditTrailFileSyncType fileType;

    public BorhanAuditTrailFileSyncCreateInfo() {
    }

    public BorhanAuditTrailFileSyncCreateInfo(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("version")) {
                ...
                this.fileType = BorhanAuditTrailFileSyncType.get(ParseUtils.parseInt(txt));
                continue;
            } 
        }
    }
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanAuditTrailFileSyncCreateInfo");

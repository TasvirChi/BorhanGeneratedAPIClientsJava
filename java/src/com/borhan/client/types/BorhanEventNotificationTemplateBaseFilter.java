...
public abstract class BorhanEventNotificationTemplateBaseFilter extends BorhanFilter {
    ...
    public BorhanEventNotificationTemplateType typeEqual;
    public String typeIn;
    public BorhanEventNotificationTemplateStatus statusEqual;
    ...
    public BorhanEventNotificationTemplateBaseFilter() {
    }

    public BorhanEventNotificationTemplateBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.typeEqual = BorhanEventNotificationTemplateType.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("typeIn")) {
                this.typeIn = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("statusEqual")) {
                this.statusEqual = BorhanEventNotificationTemplateStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanEventNotificationTemplateBaseFilter");

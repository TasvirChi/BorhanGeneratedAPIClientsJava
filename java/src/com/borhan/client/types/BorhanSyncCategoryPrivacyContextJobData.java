...
public class BorhanSyncCategoryPrivacyContextJobData extends BorhanJobData {
	/**  category id     */
    ...
    public BorhanSyncCategoryPrivacyContextJobData() {
    }

    public BorhanSyncCategoryPrivacyContextJobData(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanSyncCategoryPrivacyContextJobData");

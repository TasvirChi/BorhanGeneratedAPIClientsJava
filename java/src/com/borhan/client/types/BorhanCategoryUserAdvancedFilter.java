...
public class BorhanCategoryUserAdvancedFilter extends BorhanSearchItem {
    ...
    public BorhanCategoryUserAdvancedFilter() {
    }

    public BorhanCategoryUserAdvancedFilter(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanCategoryUserAdvancedFilter");

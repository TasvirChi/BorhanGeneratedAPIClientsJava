...
public class BorhanMetadataProfile extends BorhanObjectBase {
    ...
    public BorhanMetadataProfileStatus status;
    public String xsd;
    public String views;
    public String xslt;
    public BorhanMetadataProfileCreateMode createMode;

    public BorhanMetadataProfile() {
    }

    public BorhanMetadataProfile(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                this.status = BorhanMetadataProfileStatus.get(ParseUtils.parseInt(txt));
                continue;
                ...
                this.createMode = BorhanMetadataProfileCreateMode.get(ParseUtils.parseInt(txt));
                continue;
            } 
        }
    }
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanMetadataProfile");

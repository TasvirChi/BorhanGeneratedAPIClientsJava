...
public abstract class BorhanGenericDistributionProviderActionBaseFilter extends BorhanFilter {
    ...
    public BorhanDistributionAction actionEqual;
    public String actionIn;

    public BorhanGenericDistributionProviderActionBaseFilter() {
    }

    public BorhanGenericDistributionProviderActionBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.actionEqual = BorhanDistributionAction.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanGenericDistributionProviderActionBaseFilter");

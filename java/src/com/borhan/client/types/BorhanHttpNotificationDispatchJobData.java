...
public class BorhanHttpNotificationDispatchJobData extends BorhanEventNotificationDispatchJobData {
	/**  Remote server URL     */
    public String url;
	/**  Request method.     */
    ...
    public BorhanHttpNotificationDispatchJobData() {
    }

    public BorhanHttpNotificationDispatchJobData(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanHttpNotificationDispatchJobData");

...
public class BorhanGenericDistributionProfileAction extends BorhanObjectBase {
    ...
    public BorhanGenericDistributionProfileAction() {
    }

    public BorhanGenericDistributionProfileAction(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanGenericDistributionProfileAction");

...
public class BorhanDistributionThumbDimensions extends BorhanObjectBase {
    public int width = Integer.MIN_VALUE;
    public int height = Integer.MIN_VALUE;

    public BorhanDistributionThumbDimensions() {
    }

    public BorhanDistributionThumbDimensions(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanDistributionThumbDimensions");

...
public class BorhanKeyValue extends BorhanObjectBase {
    public String key;
    public String value;

    public BorhanKeyValue() {
    }

    public BorhanKeyValue(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanKeyValue");

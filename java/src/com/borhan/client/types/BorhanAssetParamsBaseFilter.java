...
public abstract class BorhanAssetParamsBaseFilter extends BorhanFilter {
    public String systemNameEqual;
    public String systemNameIn;
    public BorhanNullableBoolean isSystemDefaultEqual;
    public String tagsEqual;

    public BorhanAssetParamsBaseFilter() {
    }

    public BorhanAssetParamsBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("systemNameEqual")) {
                ...
                this.isSystemDefaultEqual = BorhanNullableBoolean.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanAssetParamsBaseFilter");

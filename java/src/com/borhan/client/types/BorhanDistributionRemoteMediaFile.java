...
public class BorhanDistributionRemoteMediaFile extends BorhanObjectBase {
    public String version;
    public String assetId;
    public String remoteId;

    public BorhanDistributionRemoteMediaFile() {
    }

    public BorhanDistributionRemoteMediaFile(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanDistributionRemoteMediaFile");

...
public class BorhanAccessControlScope extends BorhanObjectBase {
    ...
    public ArrayList<BorhanAccessControlContextTypeHolder> contexts;
	/**  Array of hashes to pass to the access control profile scope     */
    public ArrayList<BorhanKeyValue> hashes;

    public BorhanAccessControlScope() {
    }

    public BorhanAccessControlScope(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("referrer")) {
                ...
                this.contexts = ParseUtils.parseArray(BorhanAccessControlContextTypeHolder.class, aNode);
                continue;
            } else if (nodeName.equals("hashes")) {
                this.hashes = ParseUtils.parseArray(BorhanKeyValue.class, aNode);
                continue;
            } 
        }
    }
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanAccessControlScope");

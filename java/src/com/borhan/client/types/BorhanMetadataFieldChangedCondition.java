...
public class BorhanMetadataFieldChangedCondition extends BorhanMatchCondition {
    ...
    public BorhanMetadataFieldChangedCondition() {
    }

    public BorhanMetadataFieldChangedCondition(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanMetadataFieldChangedCondition");

...
import com.borhan.client.enums.BorhanWidevineRepositorySyncMode;
...
public class BorhanWidevineRepositorySyncJobData extends BorhanJobData {
    public BorhanWidevineRepositorySyncMode syncMode;
    public String wvAssetIds;
    public String modifiedAttributes;
    public int monitorSyncCompletion = Integer.MIN_VALUE;

    public BorhanWidevineRepositorySyncJobData() {
    }

    public BorhanWidevineRepositorySyncJobData(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("syncMode")) {
                this.syncMode = BorhanWidevineRepositorySyncMode.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanWidevineRepositorySyncJobData");

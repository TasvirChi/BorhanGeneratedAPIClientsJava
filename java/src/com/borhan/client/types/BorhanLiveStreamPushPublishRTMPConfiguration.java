...
public class BorhanLiveStreamPushPublishRTMPConfiguration extends BorhanLiveStreamPushPublishConfiguration {
    public String userId;
    public String password;
    public String streamName;
    public String applicationName;

    public BorhanLiveStreamPushPublishRTMPConfiguration() {
    }

    public BorhanLiveStreamPushPublishRTMPConfiguration(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanLiveStreamPushPublishRTMPConfiguration");

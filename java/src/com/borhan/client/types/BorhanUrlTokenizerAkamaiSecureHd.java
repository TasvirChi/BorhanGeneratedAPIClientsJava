...
public class BorhanUrlTokenizerAkamaiSecureHd extends BorhanUrlTokenizer {
    ...
    public BorhanUrlTokenizerAkamaiSecureHd() {
    }

    public BorhanUrlTokenizerAkamaiSecureHd(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanUrlTokenizerAkamaiSecureHd");

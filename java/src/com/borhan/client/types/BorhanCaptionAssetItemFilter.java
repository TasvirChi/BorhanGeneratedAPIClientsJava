...
public class BorhanCaptionAssetItemFilter extends BorhanCaptionAssetFilter {
    ...
    public BorhanLanguage languageEqual;
    ...
    public BorhanCaptionAssetItemFilter() {
    }

    public BorhanCaptionAssetItemFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("contentLike")) {
                ...
                this.languageEqual = BorhanLanguage.get(ParseUtils.parseString(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanCaptionAssetItemFilter");

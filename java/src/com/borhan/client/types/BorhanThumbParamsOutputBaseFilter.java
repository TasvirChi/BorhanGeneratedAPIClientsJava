...
public abstract class BorhanThumbParamsOutputBaseFilter extends BorhanThumbParamsFilter {
    ...
    public BorhanThumbParamsOutputBaseFilter() {
    }

    public BorhanThumbParamsOutputBaseFilter(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanThumbParamsOutputBaseFilter");

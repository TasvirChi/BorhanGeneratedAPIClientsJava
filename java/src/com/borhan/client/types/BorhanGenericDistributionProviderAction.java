...
import com.borhan.client.enums.BorhanDistributionAction;
import com.borhan.client.enums.BorhanGenericDistributionProviderStatus;
import com.borhan.client.enums.BorhanGenericDistributionProviderParser;
import com.borhan.client.enums.BorhanDistributionProtocol;
...
public class BorhanGenericDistributionProviderAction extends BorhanObjectBase {
	/**  Auto generated     */
    ...
    public BorhanDistributionAction action;
    public BorhanGenericDistributionProviderStatus status;
    public BorhanGenericDistributionProviderParser resultsParser;
    public BorhanDistributionProtocol protocol;
    ...
    public BorhanGenericDistributionProviderAction() {
    }

    public BorhanGenericDistributionProviderAction(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                this.action = BorhanDistributionAction.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("status")) {
                this.status = BorhanGenericDistributionProviderStatus.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("resultsParser")) {
                this.resultsParser = BorhanGenericDistributionProviderParser.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("protocol")) {
                this.protocol = BorhanDistributionProtocol.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanGenericDistributionProviderAction");

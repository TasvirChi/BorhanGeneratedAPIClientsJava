...
import com.borhan.client.enums.BorhanUserRoleStatus;
...
public abstract class BorhanUserRoleBaseFilter extends BorhanFilter {
    ...
    public BorhanUserRoleStatus statusEqual;
    ...
    public BorhanUserRoleBaseFilter() {
    }

    public BorhanUserRoleBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = BorhanUserRoleStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanUserRoleBaseFilter");

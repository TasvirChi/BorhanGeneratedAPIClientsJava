...
public abstract class BorhanFlavorAssetBaseFilter extends BorhanAssetFilter {
    public int flavorParamsIdEqual = Integer.MIN_VALUE;
    public String flavorParamsIdIn;
    public BorhanFlavorAssetStatus statusEqual;
    public String statusIn;
    public String statusNotIn;

    public BorhanFlavorAssetBaseFilter() {
    }

    public BorhanFlavorAssetBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("flavorParamsIdEqual")) {
                ...
                this.statusEqual = BorhanFlavorAssetStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanFlavorAssetBaseFilter");

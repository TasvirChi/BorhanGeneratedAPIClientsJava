...
public abstract class BorhanPartnerBaseFilter extends BorhanFilter {
    ...
    public BorhanPartnerStatus statusEqual;
    ...
    public BorhanPartnerGroupType partnerGroupTypeEqual;
    public String partnerNameDescriptionWebsiteAdminNameAdminEmailLike;

    public BorhanPartnerBaseFilter() {
    }

    public BorhanPartnerBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = BorhanPartnerStatus.get(ParseUtils.parseInt(txt));
                continue;
                ...
                this.partnerGroupTypeEqual = BorhanPartnerGroupType.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanPartnerBaseFilter");

...
public class BorhanTransformMetadataJobData extends BorhanJobData {
    ...
    public BorhanTransformMetadataJobData() {
    }

    public BorhanTransformMetadataJobData(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanTransformMetadataJobData");

...
public class BorhanUrlResource extends BorhanContentResource {
	/**  Remote URL, FTP, HTTP or HTTPS      */
    public String url;
	/**  Force Import Job      */
    public boolean forceAsyncDownload;

    public BorhanUrlResource() {
    }

    public BorhanUrlResource(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanUrlResource");

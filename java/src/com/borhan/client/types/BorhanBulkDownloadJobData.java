...
public class BorhanBulkDownloadJobData extends BorhanJobData {
    ...
    public BorhanBulkDownloadJobData() {
    }

    public BorhanBulkDownloadJobData(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanBulkDownloadJobData");

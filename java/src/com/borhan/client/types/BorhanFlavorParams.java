...
import com.borhan.client.enums.BorhanVideoCodec;
import com.borhan.client.enums.BorhanAudioCodec;
...
public class BorhanFlavorParams extends BorhanAssetParams {
	/**  The video codec of the Flavor Params     */
    public BorhanVideoCodec videoCodec;
	/**  The video bitrate (in KBits) of the Flavor Params     */
    public int videoBitrate = Integer.MIN_VALUE;
	/**  The audio codec of the Flavor Params     */
    public BorhanAudioCodec audioCodec;
    ...
    public BorhanFlavorParams() {
    }

    public BorhanFlavorParams(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("videoCodec")) {
                this.videoCodec = BorhanVideoCodec.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("videoBitrate")) {
                this.videoBitrate = ParseUtils.parseInt(txt);
                continue;
            } else if (nodeName.equals("audioCodec")) {
                this.audioCodec = BorhanAudioCodec.get(ParseUtils.parseString(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanFlavorParams");

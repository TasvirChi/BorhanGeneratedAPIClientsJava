...
public class BorhanEntryReplacementOptions extends BorhanObjectBase {
    ...
    public BorhanEntryReplacementOptions() {
    }

    public BorhanEntryReplacementOptions(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanEntryReplacementOptions");

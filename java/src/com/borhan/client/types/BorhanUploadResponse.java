...
import com.borhan.client.enums.BorhanUploadErrorCode;
...
public class BorhanUploadResponse extends BorhanObjectBase {
    public String uploadTokenId;
    public int fileSize = Integer.MIN_VALUE;
    public BorhanUploadErrorCode errorCode;
    public String errorDescription;

    public BorhanUploadResponse() {
    }

    public BorhanUploadResponse(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("uploadTokenId")) {
                ...
                this.errorCode = BorhanUploadErrorCode.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanUploadResponse");

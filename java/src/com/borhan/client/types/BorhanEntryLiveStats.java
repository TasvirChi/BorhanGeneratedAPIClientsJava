...
public class BorhanEntryLiveStats extends BorhanLiveStats {
    public String entryId;
    public int peakAudience = Integer.MIN_VALUE;

    public BorhanEntryLiveStats() {
    }

    public BorhanEntryLiveStats(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanEntryLiveStats");

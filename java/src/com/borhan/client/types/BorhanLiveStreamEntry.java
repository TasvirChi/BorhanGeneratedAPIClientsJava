...
public class BorhanLiveStreamEntry extends BorhanLiveEntry {
	/**  The stream id as provided by the provider     */
    public String streamRemoteId;
	/**  The backup stream id as provided by the provider     */
    public String streamRemoteBackupId;
	/**  Array of supported bitrates     */
    public ArrayList<BorhanLiveStreamBitrate> bitrates;
    ...
    public BorhanLiveStreamEntry() {
    }

    public BorhanLiveStreamEntry(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("streamRemoteId")) {
                ...
                this.bitrates = ParseUtils.parseArray(BorhanLiveStreamBitrate.class, aNode);
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanLiveStreamEntry");

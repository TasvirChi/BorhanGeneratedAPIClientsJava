...
public class BorhanBulkUploadResultEntry extends BorhanBulkUploadResult {
    ...
    public BorhanBulkUploadResultEntry() {
    }

    public BorhanBulkUploadResultEntry(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanBulkUploadResultEntry");

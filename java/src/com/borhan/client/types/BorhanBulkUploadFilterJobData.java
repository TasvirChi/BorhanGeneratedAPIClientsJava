...
public class BorhanBulkUploadFilterJobData extends BorhanBulkUploadJobData {
    ...
    public BorhanBulkUploadFilterJobData() {
    }

    public BorhanBulkUploadFilterJobData(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanBulkUploadFilterJobData");

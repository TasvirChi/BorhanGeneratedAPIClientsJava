...
public class BorhanAssetResource extends BorhanContentResource {
	/**  ID of the source asset      */
    public String assetId;

    public BorhanAssetResource() {
    }

    public BorhanAssetResource(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanAssetResource");

...
public class BorhanAccessControl extends BorhanObjectBase {
    ...
    public ArrayList<BorhanBaseRestriction> restrictions;
	/**  Indicates that the access control profile is new and should be handled using
	  BorhanAccessControlProfile object and accessControlProfile service     */
    public boolean containsUnsuportedRestrictions;

    public BorhanAccessControl() {
    }

    public BorhanAccessControl(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                this.restrictions = ParseUtils.parseArray(BorhanBaseRestriction.class, aNode);
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanAccessControl");

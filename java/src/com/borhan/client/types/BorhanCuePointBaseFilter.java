...
public abstract class BorhanCuePointBaseFilter extends BorhanFilter {
    public String idEqual;
    public String idIn;
    public BorhanCuePointType cuePointTypeEqual;
    public String cuePointTypeIn;
    public BorhanCuePointStatus statusEqual;
    ...
    public BorhanNullableBoolean forceStopEqual;
    public String systemNameEqual;
    public String systemNameIn;

    public BorhanCuePointBaseFilter() {
    }

    public BorhanCuePointBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.cuePointTypeEqual = BorhanCuePointType.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("cuePointTypeIn")) {
                this.cuePointTypeIn = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("statusEqual")) {
                this.statusEqual = BorhanCuePointStatus.get(ParseUtils.parseInt(txt));
                continue;
                ...
                this.forceStopEqual = BorhanNullableBoolean.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanCuePointBaseFilter");

...
public abstract class BorhanGenericDistributionProviderBaseFilter extends BorhanDistributionProviderFilter {
    ...
    public BorhanNullableBoolean isDefaultEqual;
    public String isDefaultIn;
    public BorhanGenericDistributionProviderStatus statusEqual;
    public String statusIn;

    public BorhanGenericDistributionProviderBaseFilter() {
    }

    public BorhanGenericDistributionProviderBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.isDefaultEqual = BorhanNullableBoolean.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("isDefaultIn")) {
                this.isDefaultIn = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("statusEqual")) {
                this.statusEqual = BorhanGenericDistributionProviderStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanGenericDistributionProviderBaseFilter");

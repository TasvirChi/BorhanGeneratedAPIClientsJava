...
public class BorhanConversionAttribute extends BorhanObjectBase {
    ...
    public BorhanConversionAttribute() {
    }

    public BorhanConversionAttribute(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanConversionAttribute");

...
public class BorhanCategoryFilter extends BorhanCategoryBaseFilter {
    ...
    public BorhanCategoryFilter() {
    }

    public BorhanCategoryFilter(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanCategoryFilter");

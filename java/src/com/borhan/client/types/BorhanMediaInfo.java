...
import com.borhan.client.enums.BorhanBitRateMode;
...
public class BorhanMediaInfo extends BorhanObjectBase {
    ...
    public BorhanBitRateMode videoBitRateMode;
	/**  The video width     */
    ...
    public BorhanBitRateMode audioBitRateMode;
    ...
    public BorhanMediaInfo() {
    }

    public BorhanMediaInfo(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                this.videoBitRateMode = BorhanBitRateMode.get(ParseUtils.parseInt(txt));
                continue;
                ...
                this.audioBitRateMode = BorhanBitRateMode.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanMediaInfo");

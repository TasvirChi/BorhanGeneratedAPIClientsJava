...
public abstract class BorhanBulkUploadBaseFilter extends BorhanFilter {
    ...
    public BorhanBulkUploadObjectType bulkUploadObjectTypeEqual;
    public String bulkUploadObjectTypeIn;

    public BorhanBulkUploadBaseFilter() {
    }

    public BorhanBulkUploadBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("uploadedOnGreaterThanOrEqual")) {
                ...
                this.bulkUploadObjectTypeEqual = BorhanBulkUploadObjectType.get(ParseUtils.parseString(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanBulkUploadBaseFilter");

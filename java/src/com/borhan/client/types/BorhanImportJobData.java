...
public class BorhanImportJobData extends BorhanJobData {
    public String srcFileUrl;
    public String destFileLocalPath;
    public String flavorAssetId;
    public int fileSize = Integer.MIN_VALUE;

    public BorhanImportJobData() {
    }

    public BorhanImportJobData(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanImportJobData");

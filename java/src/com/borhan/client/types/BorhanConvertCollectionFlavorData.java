...
public class BorhanConvertCollectionFlavorData extends BorhanObjectBase {
    ...
    public BorhanConvertCollectionFlavorData() {
    }

    public BorhanConvertCollectionFlavorData(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanConvertCollectionFlavorData");

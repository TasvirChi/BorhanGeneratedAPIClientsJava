...
public class BorhanVarPartnerUsageItem extends BorhanObjectBase {
	/**  Partner ID     */
    public int partnerId = Integer.MIN_VALUE;
	/**  Partner name     */
    public String partnerName;
	/**  Partner status     */
    public BorhanPartnerStatus partnerStatus;
	/**  Partner package     */
    ...
    public BorhanVarPartnerUsageItem() {
    }

    public BorhanVarPartnerUsageItem(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("partnerId")) {
                ...
                this.partnerStatus = BorhanPartnerStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanVarPartnerUsageItem");

...
public class BorhanCropDimensions extends BorhanObjectBase {
	/**  Crop left point     */
    ...
    public BorhanCropDimensions() {
    }

    public BorhanCropDimensions(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanCropDimensions");

...
import com.borhan.client.enums.BorhanShortLinkStatus;
...
public abstract class BorhanShortLinkBaseFilter extends BorhanFilter {
    ...
    public BorhanShortLinkStatus statusEqual;
    public String statusIn;

    public BorhanShortLinkBaseFilter() {
    }

    public BorhanShortLinkBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = BorhanShortLinkStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanShortLinkBaseFilter");

...
public abstract class BorhanEntryDistributionBaseFilter extends BorhanFilter {
    ...
    public BorhanEntryDistributionStatus statusEqual;
    public String statusIn;
    public BorhanEntryDistributionFlag dirtyStatusEqual;
    ...
    public BorhanEntryDistributionBaseFilter() {
    }

    public BorhanEntryDistributionBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = BorhanEntryDistributionStatus.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("statusIn")) {
                this.statusIn = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("dirtyStatusEqual")) {
                this.dirtyStatusEqual = BorhanEntryDistributionFlag.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanEntryDistributionBaseFilter");

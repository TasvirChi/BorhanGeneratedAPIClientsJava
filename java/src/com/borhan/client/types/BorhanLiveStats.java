...
public class BorhanLiveStats extends BorhanObjectBase {
    ...
    public BorhanLiveStats() {
    }

    public BorhanLiveStats(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanLiveStats");

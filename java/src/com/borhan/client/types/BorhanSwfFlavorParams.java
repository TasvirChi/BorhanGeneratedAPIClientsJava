...
public class BorhanSwfFlavorParams extends BorhanFlavorParams {
    public int flashVersion = Integer.MIN_VALUE;
    public boolean poly2Bitmap;

    public BorhanSwfFlavorParams() {
    }

    public BorhanSwfFlavorParams(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanSwfFlavorParams");

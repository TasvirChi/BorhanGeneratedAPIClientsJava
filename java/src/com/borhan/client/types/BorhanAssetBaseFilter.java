...
public abstract class BorhanAssetBaseFilter extends BorhanFilter {
    ...
    public BorhanAssetBaseFilter() {
    }

    public BorhanAssetBaseFilter(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanAssetBaseFilter");

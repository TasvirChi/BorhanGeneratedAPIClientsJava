...
public class BorhanAssetDistributionPropertyCondition extends BorhanAssetDistributionCondition {
    ...
    public BorhanAssetDistributionPropertyCondition() {
    }

    public BorhanAssetDistributionPropertyCondition(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanAssetDistributionPropertyCondition");

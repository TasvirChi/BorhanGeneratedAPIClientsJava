...
import com.borhan.client.enums.BorhanBatchJobType;
...
public abstract class BorhanBatchJobBaseFilter extends BorhanFilter {
    ...
    public BorhanBatchJobType jobTypeEqual;
    ...
    public BorhanBatchJobStatus statusEqual;
    ...
    public BorhanBatchJobErrorTypes errTypeEqual;
    ...
    public BorhanBatchJobBaseFilter() {
    }

    public BorhanBatchJobBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.jobTypeEqual = BorhanBatchJobType.get(ParseUtils.parseString(txt));
                continue;
                ...
                this.statusEqual = BorhanBatchJobStatus.get(ParseUtils.parseInt(txt));
                continue;
                ...
                this.errTypeEqual = BorhanBatchJobErrorTypes.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanBatchJobBaseFilter");

...
public class BorhanPostConvertJobData extends BorhanConvartableJobData {
    ...
    public BorhanPostConvertJobData() {
    }

    public BorhanPostConvertJobData(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanPostConvertJobData");

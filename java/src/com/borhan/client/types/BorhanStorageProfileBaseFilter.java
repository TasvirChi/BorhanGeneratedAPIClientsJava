...
public abstract class BorhanStorageProfileBaseFilter extends BorhanFilter {
    ...
    public BorhanStorageProfileStatus statusEqual;
    public String statusIn;
    public BorhanStorageProfileProtocol protocolEqual;
    public String protocolIn;

    public BorhanStorageProfileBaseFilter() {
    }

    public BorhanStorageProfileBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = BorhanStorageProfileStatus.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("statusIn")) {
                this.statusIn = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("protocolEqual")) {
                this.protocolEqual = BorhanStorageProfileProtocol.get(ParseUtils.parseString(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanStorageProfileBaseFilter");

...
public class BorhanSessionInfo extends BorhanObjectBase {
    public String ks;
    public BorhanSessionType sessionType;
    public int partnerId = Integer.MIN_VALUE;
    public String userId;
    public int expiry = Integer.MIN_VALUE;
    public String privileges;

    public BorhanSessionInfo() {
    }

    public BorhanSessionInfo(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("ks")) {
                ...
                this.sessionType = BorhanSessionType.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanSessionInfo");
        return kparams;
    }

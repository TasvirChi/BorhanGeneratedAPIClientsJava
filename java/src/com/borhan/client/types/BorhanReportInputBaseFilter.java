...
public class BorhanReportInputBaseFilter extends BorhanObjectBase {
    ...
    public BorhanReportInputBaseFilter() {
    }

    public BorhanReportInputBaseFilter(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanReportInputBaseFilter");

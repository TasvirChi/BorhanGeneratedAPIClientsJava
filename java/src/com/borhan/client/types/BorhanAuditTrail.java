...
public class BorhanAuditTrail extends BorhanObjectBase {
    public int id = Integer.MIN_VALUE;
    public int createdAt = Integer.MIN_VALUE;
	/**  Indicates when the data was parsed     */
    public int parsedAt = Integer.MIN_VALUE;
    public BorhanAuditTrailStatus status;
    public BorhanAuditTrailObjectType auditObjectType;
    public String objectId;
    public String relatedObjectId;
    public BorhanAuditTrailObjectType relatedObjectType;
    public String entryId;
    public int masterPartnerId = Integer.MIN_VALUE;
    public int partnerId = Integer.MIN_VALUE;
    public String requestId;
    public String userId;
    public BorhanAuditTrailAction action;
    public BorhanAuditTrailInfo data;
    public String ks;
    public BorhanAuditTrailContext context;
    ...
    public BorhanAuditTrail() {
    }

    public BorhanAuditTrail(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                this.status = BorhanAuditTrailStatus.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("auditObjectType")) {
                this.auditObjectType = BorhanAuditTrailObjectType.get(ParseUtils.parseString(txt));
                continue;
                ...
                this.relatedObjectType = BorhanAuditTrailObjectType.get(ParseUtils.parseString(txt));
                continue;
                ...
                this.action = BorhanAuditTrailAction.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("data")) {
                this.data = ParseUtils.parseObject(BorhanAuditTrailInfo.class, aNode);
                continue;
            } else if (nodeName.equals("ks")) {
                this.ks = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("context")) {
                this.context = BorhanAuditTrailContext.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanAuditTrail");

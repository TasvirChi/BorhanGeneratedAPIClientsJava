...
public class BorhanFlavorAsset extends BorhanAsset {
    ...
    public BorhanFlavorAssetStatus status;

    public BorhanFlavorAsset() {
    }

    public BorhanFlavorAsset(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("flavorParamsId")) {
                ...
                this.status = BorhanFlavorAssetStatus.get(ParseUtils.parseInt(txt));
                continue;
            } 
        }
    }
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanFlavorAsset");

...
public abstract class BorhanConversionProfileAssetParamsBaseFilter extends BorhanFilter {
    ...
    public BorhanFlavorReadyBehaviorType readyBehaviorEqual;
    public String readyBehaviorIn;
    public BorhanAssetParamsOrigin originEqual;
    public String originIn;
    public String systemNameEqual;
    public String systemNameIn;

    public BorhanConversionProfileAssetParamsBaseFilter() {
    }

    public BorhanConversionProfileAssetParamsBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("conversionProfileIdEqual")) {
                ...
                this.readyBehaviorEqual = BorhanFlavorReadyBehaviorType.get(ParseUtils.parseInt(txt));
                continue;
                ...
                this.originEqual = BorhanAssetParamsOrigin.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanConversionProfileAssetParamsBaseFilter");

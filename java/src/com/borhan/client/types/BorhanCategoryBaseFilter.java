...
public abstract class BorhanCategoryBaseFilter extends BorhanFilter {
    ...
    public BorhanAppearInListType appearInListEqual;
    public BorhanPrivacyType privacyEqual;
    public String privacyIn;
    public BorhanInheritanceType inheritanceTypeEqual;
    public String inheritanceTypeIn;
    public String referenceIdEqual;
    public BorhanNullableBoolean referenceIdEmpty;
    public BorhanContributionPolicyType contributionPolicyEqual;
    ...
    public BorhanCategoryStatus statusEqual;
    ...
    public BorhanCategoryBaseFilter() {
    }

    public BorhanCategoryBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.appearInListEqual = BorhanAppearInListType.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("privacyEqual")) {
                this.privacyEqual = BorhanPrivacyType.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("privacyIn")) {
                this.privacyIn = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("inheritanceTypeEqual")) {
                this.inheritanceTypeEqual = BorhanInheritanceType.get(ParseUtils.parseInt(txt));
                continue;
                ...
                this.referenceIdEmpty = BorhanNullableBoolean.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("contributionPolicyEqual")) {
                this.contributionPolicyEqual = BorhanContributionPolicyType.get(ParseUtils.parseInt(txt));
                continue;
                ...
                this.statusEqual = BorhanCategoryStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanCategoryBaseFilter");

...
public class BorhanLiveChannel extends BorhanLiveEntry {
	/**  Playlist id to be played     */
    public String playlistId;
	/**  Indicates that the segments should be repeated for ever     */
    public BorhanNullableBoolean repeat;

    public BorhanLiveChannel() {
    }

    public BorhanLiveChannel(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("playlistId")) {
                ...
                this.repeat = BorhanNullableBoolean.get(ParseUtils.parseInt(txt));
                continue;
            } 
        }
    }
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanLiveChannel");

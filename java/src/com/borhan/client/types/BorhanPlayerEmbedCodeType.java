...
public class BorhanPlayerEmbedCodeType extends BorhanObjectBase {
    public String id;
    public String label;
    public boolean entryOnly;
    public String minVersion;

    public BorhanPlayerEmbedCodeType() {
    }

    public BorhanPlayerEmbedCodeType(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanPlayerEmbedCodeType");

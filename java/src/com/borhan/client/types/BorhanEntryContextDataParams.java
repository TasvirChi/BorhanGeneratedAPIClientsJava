...
public class BorhanEntryContextDataParams extends BorhanAccessControlScope {
    ...
    public BorhanEntryContextDataParams() {
    }

    public BorhanEntryContextDataParams(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanEntryContextDataParams");

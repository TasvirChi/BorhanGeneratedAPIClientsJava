...
public class BorhanFtpDropFolder extends BorhanRemoteDropFolder {
    public String host;
    public int port = Integer.MIN_VALUE;
    public String username;
    public String password;

    public BorhanFtpDropFolder() {
    }

    public BorhanFtpDropFolder(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanFtpDropFolder");

...
public class BorhanMetadataSearchItem extends BorhanSearchOperator {
    public int metadataProfileId = Integer.MIN_VALUE;
    public String orderBy;

    public BorhanMetadataSearchItem() {
    }

    public BorhanMetadataSearchItem(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanMetadataSearchItem");

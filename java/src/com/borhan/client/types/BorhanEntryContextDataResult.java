...
public class BorhanEntryContextDataResult extends BorhanContextDataResult {
    ...
    public ArrayList<BorhanString> accessControlMessages;
	/**  Array of actions as received from the access control rules that invalidated     */
    public ArrayList<BorhanRuleAction> accessControlActions;
	/**  Array of allowed flavor assets according to access control limitations and
	  requested tags     */
    public ArrayList<BorhanFlavorAsset> flavorAssets;

    public BorhanEntryContextDataResult() {
    }

    public BorhanEntryContextDataResult(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("isSiteRestricted")) {
                ...
                this.accessControlMessages = ParseUtils.parseArray(BorhanString.class, aNode);
                continue;
            } else if (nodeName.equals("accessControlActions")) {
                this.accessControlActions = ParseUtils.parseArray(BorhanRuleAction.class, aNode);
                continue;
            } else if (nodeName.equals("flavorAssets")) {
                this.flavorAssets = ParseUtils.parseArray(BorhanFlavorAsset.class, aNode);
                continue;
            } 
        }
    }
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanEntryContextDataResult");

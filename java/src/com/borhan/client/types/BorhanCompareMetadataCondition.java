...
public class BorhanCompareMetadataCondition extends BorhanCompareCondition {
    ...
    public BorhanCompareMetadataCondition() {
    }

    public BorhanCompareMetadataCondition(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanCompareMetadataCondition");

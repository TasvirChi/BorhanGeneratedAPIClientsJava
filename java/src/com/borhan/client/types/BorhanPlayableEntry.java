...
import com.borhan.client.enums.BorhanDurationType;
...
public class BorhanPlayableEntry extends BorhanBaseEntry {
	/**  Number of plays     */
	...
	/**  The duration type (short for 0-4 mins, medium for 4-20 mins, long for 20+ mins) 
	     */
    public BorhanDurationType durationType;

    public BorhanPlayableEntry() {
    }

    public BorhanPlayableEntry(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("plays")) {
                ...
                this.durationType = BorhanDurationType.get(ParseUtils.parseString(txt));
                continue;
            } 
        }
    }
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanPlayableEntry");

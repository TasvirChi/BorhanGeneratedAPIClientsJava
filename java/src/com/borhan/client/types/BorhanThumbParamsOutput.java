...
public class BorhanThumbParamsOutput extends BorhanThumbParams {
    ...
    public BorhanThumbParamsOutput() {
    }

    public BorhanThumbParamsOutput(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanThumbParamsOutput");

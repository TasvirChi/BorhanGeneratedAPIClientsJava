...
import com.borhan.client.enums.BorhanPermissionItemType;
...
public abstract class BorhanPermissionItemBaseFilter extends BorhanFilter {
    public int idEqual = Integer.MIN_VALUE;
    public String idIn;
    public BorhanPermissionItemType typeEqual;
    ...
    public BorhanPermissionItemBaseFilter() {
    }

    public BorhanPermissionItemBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.typeEqual = BorhanPermissionItemType.get(ParseUtils.parseString(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanPermissionItemBaseFilter");

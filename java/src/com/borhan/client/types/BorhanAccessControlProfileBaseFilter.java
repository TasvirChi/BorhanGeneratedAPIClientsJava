...
public abstract class BorhanAccessControlProfileBaseFilter extends BorhanFilter {
    ...
    public BorhanAccessControlProfileBaseFilter() {
    }

    public BorhanAccessControlProfileBaseFilter(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanAccessControlProfileBaseFilter");

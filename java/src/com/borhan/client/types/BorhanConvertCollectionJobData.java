...
public class BorhanConvertCollectionJobData extends BorhanConvartableJobData {
    ...
    public ArrayList<BorhanConvertCollectionFlavorData> flavors;

    public BorhanConvertCollectionJobData() {
    }

    public BorhanConvertCollectionJobData(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("destDirLocalPath")) {
                ...
                this.flavors = ParseUtils.parseArray(BorhanConvertCollectionFlavorData.class, aNode);
                continue;
            } 
        }
    }
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanConvertCollectionJobData");

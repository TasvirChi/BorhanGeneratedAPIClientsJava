...
import com.borhan.client.enums.BorhanReportInterval;
...
public class BorhanReportInputFilter extends BorhanReportInputBaseFilter {
    ...
    public BorhanReportInterval interval;

    public BorhanReportInputFilter() {
    }

    public BorhanReportInputFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("keywords")) {
                ...
                this.interval = BorhanReportInterval.get(ParseUtils.parseString(txt));
                continue;
            } 
        }
    }
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanReportInputFilter");

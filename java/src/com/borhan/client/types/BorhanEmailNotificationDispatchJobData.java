...
public class BorhanEmailNotificationDispatchJobData extends BorhanEventNotificationDispatchJobData {
	/**  Define the email sender email     */
    public String fromEmail;
	/**  Define the email sender name     */
    public String fromName;
	/**  Email recipient emails and names, key is mail address and value is the name     */
    public BorhanEmailNotificationRecipientJobData to;
	/**  Email cc emails and names, key is mail address and value is the name     */
    public BorhanEmailNotificationRecipientJobData cc;
	/**  Email bcc emails and names, key is mail address and value is the name     */
    public BorhanEmailNotificationRecipientJobData bcc;
	/**  Email addresses that a replies should be sent to, key is mail address and value
	  is the name     */
    public BorhanEmailNotificationRecipientJobData replyTo;
    ...
    public BorhanEmailNotificationDispatchJobData() {
    }

    public BorhanEmailNotificationDispatchJobData(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("fromEmail")) {
                ...
                this.to = ParseUtils.parseObject(BorhanEmailNotificationRecipientJobData.class, aNode);
                continue;
            } else if (nodeName.equals("cc")) {
                this.cc = ParseUtils.parseObject(BorhanEmailNotificationRecipientJobData.class, aNode);
                continue;
            } else if (nodeName.equals("bcc")) {
                this.bcc = ParseUtils.parseObject(BorhanEmailNotificationRecipientJobData.class, aNode);
                continue;
            } else if (nodeName.equals("replyTo")) {
                this.replyTo = ParseUtils.parseObject(BorhanEmailNotificationRecipientJobData.class, aNode);
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanEmailNotificationDispatchJobData");

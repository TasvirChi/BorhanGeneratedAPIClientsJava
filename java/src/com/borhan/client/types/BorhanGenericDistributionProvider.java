...
public class BorhanGenericDistributionProvider extends BorhanDistributionProvider {
	/**  Auto generated     */
    ...
    public BorhanGenericDistributionProvider() {
    }

    public BorhanGenericDistributionProvider(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanGenericDistributionProvider");

...
public abstract class BorhanAccessControlBaseFilter extends BorhanFilter {
    ...
    public BorhanAccessControlBaseFilter() {
    }

    public BorhanAccessControlBaseFilter(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanAccessControlBaseFilter");

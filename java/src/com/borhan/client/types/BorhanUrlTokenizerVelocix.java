...
public class BorhanUrlTokenizerVelocix extends BorhanUrlTokenizer {
	/**  hdsPaths     */
    ...
    public BorhanUrlTokenizerVelocix() {
    }

    public BorhanUrlTokenizerVelocix(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanUrlTokenizerVelocix");

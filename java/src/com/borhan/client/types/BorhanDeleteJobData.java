...
public class BorhanDeleteJobData extends BorhanJobData {
	/**  The filter should return the list of objects that need to be deleted.     */
    public BorhanFilter filter;

    public BorhanDeleteJobData() {
    }

    public BorhanDeleteJobData(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanDeleteJobData");

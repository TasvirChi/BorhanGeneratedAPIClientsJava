...
public class BorhanGenericSyndicationFeed extends BorhanBaseSyndicationFeed {
	/**  feed description       */
    public String feedDescription;
	/**  feed landing page (i.e publisher website)    */
    public String feedLandingPage;

    public BorhanGenericSyndicationFeed() {
    }

    public BorhanGenericSyndicationFeed(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanGenericSyndicationFeed");

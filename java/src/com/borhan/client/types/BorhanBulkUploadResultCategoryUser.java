...
public class BorhanBulkUploadResultCategoryUser extends BorhanBulkUploadResult {
    ...
    public BorhanBulkUploadResultCategoryUser() {
    }

    public BorhanBulkUploadResultCategoryUser(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanBulkUploadResultCategoryUser");

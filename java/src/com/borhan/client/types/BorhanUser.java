...
import com.borhan.client.enums.BorhanGender;
...
public class BorhanUser extends BorhanObjectBase {
    public String id;
    ...
    public BorhanGender gender;
    public BorhanUserStatus status;
    ...
    public BorhanUser(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                this.gender = BorhanGender.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("status")) {
                this.status = BorhanUserStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanUser");

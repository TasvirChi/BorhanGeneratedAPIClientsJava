...
public class BorhanUiConf extends BorhanObjectBase {
    public int id = Integer.MIN_VALUE;
	/**  Name of the uiConf, this is not a primary key     */
    public String name;
    public String description;
    public int partnerId = Integer.MIN_VALUE;
    public BorhanUiConfObjType objType;
    ...
    public BorhanUiConfCreationMode creationMode;
    ...
    public BorhanUiConf(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                this.objType = BorhanUiConfObjType.get(ParseUtils.parseInt(txt));
                continue;
                ...
                this.creationMode = BorhanUiConfCreationMode.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanUiConf");

...
public class BorhanLiveReportInputFilter extends BorhanObjectBase {
    public String entryIds;
    public int fromTime = Integer.MIN_VALUE;
    public int toTime = Integer.MIN_VALUE;
    public BorhanNullableBoolean live;

    public BorhanLiveReportInputFilter() {
    }

    public BorhanLiveReportInputFilter(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("entryIds")) {
                ...
                this.live = BorhanNullableBoolean.get(ParseUtils.parseInt(txt));
                continue;
            } 
        }
    }
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanLiveReportInputFilter");

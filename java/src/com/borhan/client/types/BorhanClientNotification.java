...
public class BorhanClientNotification extends BorhanObjectBase {
	/**  The URL where the notification should be sent to         */
    public String url;
	/**  The serialized notification data to send        */
    public String data;

    public BorhanClientNotification() {
    }

    public BorhanClientNotification(Element node) throws BorhanApiException {
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanClientNotification");

...
public class BorhanUploadToken extends BorhanObjectBase {
    ...
    public BorhanUploadTokenStatus status;
    ...
    public BorhanUploadToken() {
    }

    public BorhanUploadToken(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                this.status = BorhanUploadTokenStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanUploadToken");

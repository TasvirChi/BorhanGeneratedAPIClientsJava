...
public abstract class BorhanWidgetBaseFilter extends BorhanFilter {
    ...
    public BorhanWidgetBaseFilter() {
    }

    public BorhanWidgetBaseFilter(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanWidgetBaseFilter");

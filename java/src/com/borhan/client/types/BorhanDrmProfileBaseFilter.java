...
public abstract class BorhanDrmProfileBaseFilter extends BorhanFilter {
    ...
    public BorhanDrmProfileStatus statusEqual;
    public String statusIn;

    public BorhanDrmProfileBaseFilter() {
    }

    public BorhanDrmProfileBaseFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = BorhanDrmProfileStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanDrmProfileBaseFilter");

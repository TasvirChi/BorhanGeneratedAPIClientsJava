...
public class BorhanCodeCuePoint extends BorhanCuePoint {
    public String code;
    ...
    public BorhanCodeCuePoint() {
    }

    public BorhanCodeCuePoint(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanCodeCuePoint");

...
public class BorhanConvertLiveSegmentJobData extends BorhanJobData {
	/**  Live stream entry id     */
    public String entryId;
    public String assetId;
	/**  Primary or secondary media server     */
    public BorhanMediaServerIndex mediaServerIndex;
    ...
    public BorhanConvertLiveSegmentJobData() {
    }

    public BorhanConvertLiveSegmentJobData(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("entryId")) {
                ...
                this.mediaServerIndex = BorhanMediaServerIndex.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanConvertLiveSegmentJobData");

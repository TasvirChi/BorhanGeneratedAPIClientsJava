...
public abstract class BorhanMediaServerBaseFilter extends BorhanFilter {
    ...
    public BorhanMediaServerBaseFilter() {
    }

    public BorhanMediaServerBaseFilter(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanMediaServerBaseFilter");

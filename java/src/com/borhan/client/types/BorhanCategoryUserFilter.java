...
public class BorhanCategoryUserFilter extends BorhanCategoryUserBaseFilter {
    ...
    public BorhanCategoryUserFilter() {
    }

    public BorhanCategoryUserFilter(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanCategoryUserFilter");

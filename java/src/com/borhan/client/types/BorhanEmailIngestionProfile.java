...
import com.borhan.client.enums.BorhanEmailIngestionProfileStatus;
...
public class BorhanEmailIngestionProfile extends BorhanObjectBase {
    ...
    public BorhanEmailIngestionProfileStatus status;
    ...
    public BorhanEmailIngestionProfile() {
    }

    public BorhanEmailIngestionProfile(Element node) throws BorhanApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                this.status = BorhanEmailIngestionProfileStatus.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanEmailIngestionProfile");

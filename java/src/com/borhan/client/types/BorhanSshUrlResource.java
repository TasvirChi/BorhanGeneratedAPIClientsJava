...
public class BorhanSshUrlResource extends BorhanUrlResource {
	/**  SSH private key     */
    ...
    public BorhanSshUrlResource() {
    }

    public BorhanSshUrlResource(Element node) throws BorhanApiException {
        super(node);
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanSshUrlResource");

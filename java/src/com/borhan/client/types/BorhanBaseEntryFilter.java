...
public class BorhanBaseEntryFilter extends BorhanBaseEntryBaseFilter {
    public String freeText;
    public BorhanNullableBoolean isRoot;
    ...
    public BorhanBaseEntryFilter() {
    }

    public BorhanBaseEntryFilter(Element node) throws BorhanApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("freeText")) {
                ...
                this.isRoot = BorhanNullableBoolean.get(ParseUtils.parseInt(txt));
                continue;
    ...
    public BorhanParams toParams() {
        ...
        kparams.add("objectType", "BorhanBaseEntryFilter");

...
public class MultiRequestTest extends BaseTest{
	...
	public void testMultiRequest() throws Exception {
		...
		uploadToken = client.getUploadTokenService().upload("{3:result:id}", fileData, BorhanTestConfig.UPLOAD_IMAGE, fileData.available(), false);
	 ...
	 */
	public void testMultiRequestWithError() throws BorhanApiException {

...
public class SystemServiceTest extends BaseTest {
	...
	private IBorhanLogger logger = BorhanLogger.getLogger(SystemServiceTest.class);
	...
	public void testPing() {
		...
		try {
			BaseTest.startUserSession(client,borhanConfig);
			BorhanSystemService systemService = this.client.getSystemService();

 ...
 * 
 */
public class BorhanParams extends HashMap<String, String> {
	...
	public String toQueryString() throws BorhanApiException {
		...
		try {
			...
			throw new BorhanApiException("Failed to generate query string");
		}
	}
	...
	public void add(BorhanParams objectProperties) {
		this.putAll(objectProperties);
	}
	
	public void addMulti(int idx, BorhanParams objectProperties) {

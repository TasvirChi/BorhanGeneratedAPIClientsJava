 ...
 */
public enum BorhanFileSyncObjectType implements BorhanEnumAsString {
    ...
    BorhanFileSyncObjectType(String hashCode) {
    ...
    public static BorhanFileSyncObjectType get(String hashCode) {

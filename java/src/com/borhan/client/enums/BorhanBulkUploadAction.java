 ...
 */
public enum BorhanBulkUploadAction implements BorhanEnumAsString {
    ADD ("1"),
    UPDATE ("2"),
    DELETE ("3"),
    REPLACE ("4"),
    ...
    BorhanBulkUploadAction(String hashCode) {
    ...
    public static BorhanBulkUploadAction get(String hashCode) {

 ...
 */
public enum BorhanMetadataObjectType implements BorhanEnumAsString {
    ...
    BorhanMetadataObjectType(String hashCode) {
    ...
    public static BorhanMetadataObjectType get(String hashCode) {

 ...
 */
public enum BorhanGenericXsltSyndicationFeedOrderBy implements BorhanEnumAsString {
    ...
    BorhanGenericXsltSyndicationFeedOrderBy(String hashCode) {
    ...
    public static BorhanGenericXsltSyndicationFeedOrderBy get(String hashCode) {

 ...
 */
public enum BorhanDistributionErrorType implements BorhanEnumAsInt {
    MISSING_FLAVOR (1),
    MISSING_THUMBNAIL (2),
    MISSING_METADATA (3),
    INVALID_DATA (4),
    ...
    BorhanDistributionErrorType(int hashCode) {
    ...
    public static BorhanDistributionErrorType get(int hashCode) {
        switch(hashCode) {

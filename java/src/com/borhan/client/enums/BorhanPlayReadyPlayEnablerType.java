 ...
 */
public enum BorhanPlayReadyPlayEnablerType implements BorhanEnumAsString {
    ...
    BorhanPlayReadyPlayEnablerType(String hashCode) {
    ...
    public static BorhanPlayReadyPlayEnablerType get(String hashCode) {

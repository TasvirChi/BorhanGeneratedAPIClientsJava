 ...
 */
public enum BorhanBaseEntryOrderBy implements BorhanEnumAsString {
    ...
    BorhanBaseEntryOrderBy(String hashCode) {
    ...
    public static BorhanBaseEntryOrderBy get(String hashCode) {

 ...
 */
public enum BorhanDropFolderFileErrorCode implements BorhanEnumAsString {
    ...
    BorhanDropFolderFileErrorCode(String hashCode) {
    ...
    public static BorhanDropFolderFileErrorCode get(String hashCode) {

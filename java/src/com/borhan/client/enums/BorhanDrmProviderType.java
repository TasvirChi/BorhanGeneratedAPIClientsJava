 ...
 */
public enum BorhanDrmProviderType implements BorhanEnumAsString {
    PLAY_READY ("playReady.PLAY_READY"),
    WIDEVINE ("widevine.WIDEVINE");

    public String hashCode;

    BorhanDrmProviderType(String hashCode) {
    ...
    public static BorhanDrmProviderType get(String hashCode) {

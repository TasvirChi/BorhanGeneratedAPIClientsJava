 ...
 */
public enum BorhanMediaParserType implements BorhanEnumAsString {
    MEDIAINFO ("0"),
    ...
    BorhanMediaParserType(String hashCode) {
    ...
    public static BorhanMediaParserType get(String hashCode) {

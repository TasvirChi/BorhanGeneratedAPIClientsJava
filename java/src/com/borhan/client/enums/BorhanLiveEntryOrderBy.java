 ...
 */
public enum BorhanLiveEntryOrderBy implements BorhanEnumAsString {
    ...
    BorhanLiveEntryOrderBy(String hashCode) {
    ...
    public static BorhanLiveEntryOrderBy get(String hashCode) {

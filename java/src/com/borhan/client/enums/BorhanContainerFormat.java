 ...
 */
public enum BorhanContainerFormat implements BorhanEnumAsString {
    _3GP ("3gp"),
    APPLEHTTP ("applehttp"),
    AVI ("avi"),
    BMP ("bmp"),
    ...
    BorhanContainerFormat(String hashCode) {
    ...
    public static BorhanContainerFormat get(String hashCode) {

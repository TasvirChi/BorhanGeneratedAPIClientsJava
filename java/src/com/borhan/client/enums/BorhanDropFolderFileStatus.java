 ...
 */
public enum BorhanDropFolderFileStatus implements BorhanEnumAsInt {
    UPLOADING (1),
    PENDING (2),
    WAITING (3),
    HANDLED (4),
    ...
    BorhanDropFolderFileStatus(int hashCode) {
    ...
    public static BorhanDropFolderFileStatus get(int hashCode) {
        switch(hashCode) {

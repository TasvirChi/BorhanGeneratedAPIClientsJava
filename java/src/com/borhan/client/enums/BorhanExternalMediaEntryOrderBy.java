 ...
 */
public enum BorhanExternalMediaEntryOrderBy implements BorhanEnumAsString {
    ...
    BorhanExternalMediaEntryOrderBy(String hashCode) {
    ...
    public static BorhanExternalMediaEntryOrderBy get(String hashCode) {

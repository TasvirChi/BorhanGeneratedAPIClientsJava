 ...
 */
public enum BorhanGoogleVideoSyndicationFeedOrderBy implements BorhanEnumAsString {
    ...
    BorhanGoogleVideoSyndicationFeedOrderBy(String hashCode) {
    ...
    public static BorhanGoogleVideoSyndicationFeedOrderBy get(String hashCode) {

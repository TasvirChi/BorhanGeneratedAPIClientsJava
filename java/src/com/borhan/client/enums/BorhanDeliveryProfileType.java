 ...
 */
public enum BorhanDeliveryProfileType implements BorhanEnumAsString {
    ...
    BorhanDeliveryProfileType(String hashCode) {
    ...
    public static BorhanDeliveryProfileType get(String hashCode) {

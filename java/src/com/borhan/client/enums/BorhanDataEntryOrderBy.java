 ...
 */
public enum BorhanDataEntryOrderBy implements BorhanEnumAsString {
    ...
    BorhanDataEntryOrderBy(String hashCode) {
    ...
    public static BorhanDataEntryOrderBy get(String hashCode) {

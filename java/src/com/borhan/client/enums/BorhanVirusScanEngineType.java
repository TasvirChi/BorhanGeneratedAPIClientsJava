 ...
 */
public enum BorhanVirusScanEngineType implements BorhanEnumAsString {
    ...
    BorhanVirusScanEngineType(String hashCode) {
    ...
    public static BorhanVirusScanEngineType get(String hashCode) {

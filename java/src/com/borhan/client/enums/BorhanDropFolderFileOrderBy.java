 ...
 */
public enum BorhanDropFolderFileOrderBy implements BorhanEnumAsString {
    ...
    BorhanDropFolderFileOrderBy(String hashCode) {
    ...
    public static BorhanDropFolderFileOrderBy get(String hashCode) {

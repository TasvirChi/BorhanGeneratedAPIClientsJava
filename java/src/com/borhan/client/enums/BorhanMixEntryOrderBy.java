 ...
 */
public enum BorhanMixEntryOrderBy implements BorhanEnumAsString {
    ...
    BorhanMixEntryOrderBy(String hashCode) {
    ...
    public static BorhanMixEntryOrderBy get(String hashCode) {

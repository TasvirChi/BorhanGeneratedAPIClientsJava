 ...
 */
public enum BorhanCuePointOrderBy implements BorhanEnumAsString {
    ...
    BorhanCuePointOrderBy(String hashCode) {
    ...
    public static BorhanCuePointOrderBy get(String hashCode) {

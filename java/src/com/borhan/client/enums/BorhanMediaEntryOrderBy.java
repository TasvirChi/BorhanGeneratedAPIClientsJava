 ...
 */
public enum BorhanMediaEntryOrderBy implements BorhanEnumAsString {
    ...
    BorhanMediaEntryOrderBy(String hashCode) {
    ...
    public static BorhanMediaEntryOrderBy get(String hashCode) {

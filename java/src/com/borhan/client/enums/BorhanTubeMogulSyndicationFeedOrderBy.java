 ...
 */
public enum BorhanTubeMogulSyndicationFeedOrderBy implements BorhanEnumAsString {
    ...
    BorhanTubeMogulSyndicationFeedOrderBy(String hashCode) {
    ...
    public static BorhanTubeMogulSyndicationFeedOrderBy get(String hashCode) {

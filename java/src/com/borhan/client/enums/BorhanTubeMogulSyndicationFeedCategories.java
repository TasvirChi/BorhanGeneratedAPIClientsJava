 ...
 */
public enum BorhanTubeMogulSyndicationFeedCategories implements BorhanEnumAsString {
    ...
    BorhanTubeMogulSyndicationFeedCategories(String hashCode) {
    ...
    public static BorhanTubeMogulSyndicationFeedCategories get(String hashCode) {

 ...
 */
public enum BorhanDistributionProviderType implements BorhanEnumAsString {
    ...
    BorhanDistributionProviderType(String hashCode) {
    ...
    public static BorhanDistributionProviderType get(String hashCode) {
        ...
        if (hashCode.equals("crossBorhanDistribution.CROSS_BORHAN"))
        {
           return CROSS_BORHAN;
        }
        else 

 ...
 */
public enum BorhanEventNotificationEventType implements BorhanEnumAsString {
    BATCH_JOB_STATUS ("1"),
    OBJECT_ADDED ("2"),
    OBJECT_CHANGED ("3"),
    OBJECT_COPIED ("4"),
    ...
    BorhanEventNotificationEventType(String hashCode) {
    ...
    public static BorhanEventNotificationEventType get(String hashCode) {

 ...
 */
public enum BorhanCountryRestrictionType implements BorhanEnumAsInt {
    RESTRICT_COUNTRY_LIST (0),
    ALLOW_COUNTRY_LIST (1);

    public int hashCode;

    BorhanCountryRestrictionType(int hashCode) {
    ...
    public static BorhanCountryRestrictionType get(int hashCode) {
        switch(hashCode) {

 ...
 */
public enum BorhanCategoryOrderBy implements BorhanEnumAsString {
    ...
    BorhanCategoryOrderBy(String hashCode) {
    ...
    public static BorhanCategoryOrderBy get(String hashCode) {

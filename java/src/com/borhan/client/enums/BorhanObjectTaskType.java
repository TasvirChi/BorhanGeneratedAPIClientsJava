 ...
 */
public enum BorhanObjectTaskType implements BorhanEnumAsString {
    ...
    BorhanObjectTaskType(String hashCode) {
    ...
    public static BorhanObjectTaskType get(String hashCode) {

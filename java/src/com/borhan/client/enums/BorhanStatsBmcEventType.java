 ...
 */
public enum BorhanStatsBmcEventType implements BorhanEnumAsInt {
    ...
    BorhanStatsBmcEventType(int hashCode) {
    ...
    public static BorhanStatsBmcEventType get(int hashCode) {
        switch(hashCode) {
            ...
            case 1023: return CONTENT_ADMIN_BCW_UPLOAD;

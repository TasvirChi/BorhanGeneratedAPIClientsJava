 ...
 */
public enum BorhanEntryDistributionFlag implements BorhanEnumAsInt {
    NONE (0),
    SUBMIT_REQUIRED (1),
    DELETE_REQUIRED (2),
    UPDATE_REQUIRED (3),
    ...
    BorhanEntryDistributionFlag(int hashCode) {
    ...
    public static BorhanEntryDistributionFlag get(int hashCode) {
        switch(hashCode) {
            case 0: return NONE;

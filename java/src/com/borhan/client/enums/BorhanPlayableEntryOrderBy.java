 ...
 */
public enum BorhanPlayableEntryOrderBy implements BorhanEnumAsString {
    ...
    BorhanPlayableEntryOrderBy(String hashCode) {
    ...
    public static BorhanPlayableEntryOrderBy get(String hashCode) {

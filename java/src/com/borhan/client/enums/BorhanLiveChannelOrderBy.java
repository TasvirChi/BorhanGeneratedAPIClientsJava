 ...
 */
public enum BorhanLiveChannelOrderBy implements BorhanEnumAsString {
    ...
    BorhanLiveChannelOrderBy(String hashCode) {
    ...
    public static BorhanLiveChannelOrderBy get(String hashCode) {

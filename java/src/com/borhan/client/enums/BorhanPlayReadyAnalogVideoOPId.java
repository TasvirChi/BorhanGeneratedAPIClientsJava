 ...
 */
public enum BorhanPlayReadyAnalogVideoOPId implements BorhanEnumAsString {
    ...
    BorhanPlayReadyAnalogVideoOPId(String hashCode) {
    ...
    public static BorhanPlayReadyAnalogVideoOPId get(String hashCode) {

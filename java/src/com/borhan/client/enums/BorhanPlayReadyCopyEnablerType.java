 ...
 */
public enum BorhanPlayReadyCopyEnablerType implements BorhanEnumAsString {
    ...
    BorhanPlayReadyCopyEnablerType(String hashCode) {
    ...
    public static BorhanPlayReadyCopyEnablerType get(String hashCode) {

 ...
 */
public enum BorhanCodeCuePointOrderBy implements BorhanEnumAsString {
    ...
    BorhanCodeCuePointOrderBy(String hashCode) {
    ...
    public static BorhanCodeCuePointOrderBy get(String hashCode) {

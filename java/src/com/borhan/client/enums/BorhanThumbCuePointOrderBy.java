 ...
 */
public enum BorhanThumbCuePointOrderBy implements BorhanEnumAsString {
    ...
    BorhanThumbCuePointOrderBy(String hashCode) {
    ...
    public static BorhanThumbCuePointOrderBy get(String hashCode) {

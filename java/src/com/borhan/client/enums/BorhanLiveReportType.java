 ...
 */
public enum BorhanLiveReportType implements BorhanEnumAsString {
    ...
    BorhanLiveReportType(String hashCode) {
    ...
    public static BorhanLiveReportType get(String hashCode) {

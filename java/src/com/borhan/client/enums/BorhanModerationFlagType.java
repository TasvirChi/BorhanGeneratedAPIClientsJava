 ...
 */
public enum BorhanModerationFlagType implements BorhanEnumAsInt {
    SEXUAL_CONTENT (1),
    VIOLENT_REPULSIVE (2),
    HARMFUL_DANGEROUS (3),
    SPAM_COMMERCIALS (4),
    ...
    BorhanModerationFlagType(int hashCode) {
    ...
    public static BorhanModerationFlagType get(int hashCode) {
        switch(hashCode) {

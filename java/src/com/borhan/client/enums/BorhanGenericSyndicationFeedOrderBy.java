 ...
 */
public enum BorhanGenericSyndicationFeedOrderBy implements BorhanEnumAsString {
    ...
    BorhanGenericSyndicationFeedOrderBy(String hashCode) {
    ...
    public static BorhanGenericSyndicationFeedOrderBy get(String hashCode) {

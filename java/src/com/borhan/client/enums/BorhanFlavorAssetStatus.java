 ...
 */
public enum BorhanFlavorAssetStatus implements BorhanEnumAsInt {
    ERROR (-1),
    QUEUED (0),
    CONVERTING (1),
    READY (2),
    ...
    BorhanFlavorAssetStatus(int hashCode) {
    ...
    public static BorhanFlavorAssetStatus get(int hashCode) {
        switch(hashCode) {
            case -1: return ERROR;

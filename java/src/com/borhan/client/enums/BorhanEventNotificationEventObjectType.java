 ...
 */
public enum BorhanEventNotificationEventObjectType implements BorhanEnumAsString {
    ...
    BorhanEventNotificationEventObjectType(String hashCode) {
    ...
    public static BorhanEventNotificationEventObjectType get(String hashCode) {

 ...
 */
public enum BorhanLiveStreamEntryOrderBy implements BorhanEnumAsString {
    ...
    BorhanLiveStreamEntryOrderBy(String hashCode) {
    ...
    public static BorhanLiveStreamEntryOrderBy get(String hashCode) {

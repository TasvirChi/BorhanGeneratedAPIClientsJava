 ...
 */
public enum BorhanAnnotationOrderBy implements BorhanEnumAsString {
    ...
    BorhanAnnotationOrderBy(String hashCode) {
    ...
    public static BorhanAnnotationOrderBy get(String hashCode) {

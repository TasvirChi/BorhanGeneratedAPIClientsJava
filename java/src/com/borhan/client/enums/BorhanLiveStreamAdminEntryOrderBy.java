 ...
 */
public enum BorhanLiveStreamAdminEntryOrderBy implements BorhanEnumAsString {
    ...
    BorhanLiveStreamAdminEntryOrderBy(String hashCode) {
    ...
    public static BorhanLiveStreamAdminEntryOrderBy get(String hashCode) {

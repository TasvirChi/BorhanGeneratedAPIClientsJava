 ...
 */
public enum BorhanBaseSyndicationFeedOrderBy implements BorhanEnumAsString {
    ...
    BorhanBaseSyndicationFeedOrderBy(String hashCode) {
    ...
    public static BorhanBaseSyndicationFeedOrderBy get(String hashCode) {

 ...
 */
public enum BorhanEntryDistributionOrderBy implements BorhanEnumAsString {
    ...
    BorhanEntryDistributionOrderBy(String hashCode) {
    ...
    public static BorhanEntryDistributionOrderBy get(String hashCode) {

 ...
 */
public enum BorhanFileSyncOrderBy implements BorhanEnumAsString {
    ...
    BorhanFileSyncOrderBy(String hashCode) {
    ...
    public static BorhanFileSyncOrderBy get(String hashCode) {

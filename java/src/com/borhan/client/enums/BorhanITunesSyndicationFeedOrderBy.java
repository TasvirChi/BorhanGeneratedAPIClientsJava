 ...
 */
public enum BorhanITunesSyndicationFeedOrderBy implements BorhanEnumAsString {
    ...
    BorhanITunesSyndicationFeedOrderBy(String hashCode) {
    ...
    public static BorhanITunesSyndicationFeedOrderBy get(String hashCode) {

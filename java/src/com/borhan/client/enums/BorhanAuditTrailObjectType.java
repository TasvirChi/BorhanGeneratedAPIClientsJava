 ...
 */
public enum BorhanAuditTrailObjectType implements BorhanEnumAsString {
    BATCH_JOB ("BatchJob"),
    ...
    BorhanAuditTrailObjectType(String hashCode) {
    ...
    public static BorhanAuditTrailObjectType get(String hashCode) {

 ...
 */
public enum BorhanMetadataOrderBy implements BorhanEnumAsString {
    ...
    BorhanMetadataOrderBy(String hashCode) {
    ...
    public static BorhanMetadataOrderBy get(String hashCode) {

 ...
 */
public enum BorhanPlaylistOrderBy implements BorhanEnumAsString {
    ...
    BorhanPlaylistOrderBy(String hashCode) {
    ...
    public static BorhanPlaylistOrderBy get(String hashCode) {

 ...
 */
public enum BorhanMailType implements BorhanEnumAsString {
    MAIL_TYPE_BORHAN_NEWSLETTER ("10"),
    MAIL_TYPE_ADDED_TO_FAVORITES ("11"),
    MAIL_TYPE_ADDED_TO_CLIP_FAVORITES ("12"),
    MAIL_TYPE_NEW_COMMENT_IN_PROFILE ("13"),
    MAIL_TYPE_CLIP_ADDED_YOUR_BORHAN ("20"),
    MAIL_TYPE_VIDEO_ADDED ("21"),
    MAIL_TYPE_ROUGHCUT_CREATED ("22"),
    MAIL_TYPE_ADDED_BORHAN_TO_YOUR_FAVORITES ("23"),
    MAIL_TYPE_NEW_COMMENT_IN_BORHAN ("24"),
    MAIL_TYPE_CLIP_ADDED ("30"),
    MAIL_TYPE_VIDEO_CREATED ("31"),
    MAIL_TYPE_ADDED_BORHAN_TO_HIS_FAVORITES ("32"),
    MAIL_TYPE_NEW_COMMENT_IN_BORHAN_YOU_CONTRIBUTED ("33"),
    MAIL_TYPE_CLIP_CONTRIBUTED ("40"),
    MAIL_TYPE_ROUGHCUT_CREATED_SUBSCRIBED ("41"),
    MAIL_TYPE_ADDED_BORHAN_TO_HIS_FAVORITES_SUBSCRIBED ("42"),
    MAIL_TYPE_NEW_COMMENT_IN_BORHAN_YOU_SUBSCRIBED ("43"),
    ...
    BorhanMailType(String hashCode) {
    ...
    public static BorhanMailType get(String hashCode) {
        if (hashCode.equals("10"))
        {
           return MAIL_TYPE_BORHAN_NEWSLETTER;
        }
        else 
        ...
        {
           return MAIL_TYPE_CLIP_ADDED_YOUR_BORHAN;
        }
        else 
        ...
        {
           return MAIL_TYPE_ADDED_BORHAN_TO_YOUR_FAVORITES;
        }
        else 
        if (hashCode.equals("24"))
        {
           return MAIL_TYPE_NEW_COMMENT_IN_BORHAN;
        }
        else 
        ...
        {
           return MAIL_TYPE_ADDED_BORHAN_TO_HIS_FAVORITES;
        }
        else 
        if (hashCode.equals("33"))
        {
           return MAIL_TYPE_NEW_COMMENT_IN_BORHAN_YOU_CONTRIBUTED;
        }
        else 
        ...
        {
           return MAIL_TYPE_ADDED_BORHAN_TO_HIS_FAVORITES_SUBSCRIBED;
        }
        else 
        if (hashCode.equals("43"))
        {
           return MAIL_TYPE_NEW_COMMENT_IN_BORHAN_YOU_SUBSCRIBED;
        }
        else 

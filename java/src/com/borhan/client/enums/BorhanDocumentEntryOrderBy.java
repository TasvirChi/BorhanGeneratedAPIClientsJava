 ...
 */
public enum BorhanDocumentEntryOrderBy implements BorhanEnumAsString {
    ...
    BorhanDocumentEntryOrderBy(String hashCode) {
    ...
    public static BorhanDocumentEntryOrderBy get(String hashCode) {

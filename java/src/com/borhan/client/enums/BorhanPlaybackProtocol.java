 ...
 */
public enum BorhanPlaybackProtocol implements BorhanEnumAsString {
    ...
    BorhanPlaybackProtocol(String hashCode) {
    ...
    public static BorhanPlaybackProtocol get(String hashCode) {

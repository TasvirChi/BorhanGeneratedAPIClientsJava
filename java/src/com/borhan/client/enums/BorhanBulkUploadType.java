 ...
 */
public enum BorhanBulkUploadType implements BorhanEnumAsString {
    ...
    BorhanBulkUploadType(String hashCode) {
    ...
    public static BorhanBulkUploadType get(String hashCode) {

 ...
 */
public enum BorhanBatchJobOrderBy implements BorhanEnumAsString {
    ...
    BorhanBatchJobOrderBy(String hashCode) {
    ...
    public static BorhanBatchJobOrderBy get(String hashCode) {

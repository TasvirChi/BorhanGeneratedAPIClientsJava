 ...
 */
public enum BorhanDropFolderType implements BorhanEnumAsString {
    ...
    BorhanDropFolderType(String hashCode) {
    ...
    public static BorhanDropFolderType get(String hashCode) {

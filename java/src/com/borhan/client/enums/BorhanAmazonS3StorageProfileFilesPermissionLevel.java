 ...
 */
public enum BorhanAmazonS3StorageProfileFilesPermissionLevel implements BorhanEnumAsString {
    ...
    BorhanAmazonS3StorageProfileFilesPermissionLevel(String hashCode) {
    ...
    public static BorhanAmazonS3StorageProfileFilesPermissionLevel get(String hashCode) {

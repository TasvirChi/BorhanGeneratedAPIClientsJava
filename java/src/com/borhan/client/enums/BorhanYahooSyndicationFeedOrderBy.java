 ...
 */
public enum BorhanYahooSyndicationFeedOrderBy implements BorhanEnumAsString {
    ...
    BorhanYahooSyndicationFeedOrderBy(String hashCode) {
    ...
    public static BorhanYahooSyndicationFeedOrderBy get(String hashCode) {

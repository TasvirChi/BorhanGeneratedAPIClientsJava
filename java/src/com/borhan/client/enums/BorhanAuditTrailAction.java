 ...
 */
public enum BorhanAuditTrailAction implements BorhanEnumAsString {
    CHANGED ("CHANGED"),
    ...
    BorhanAuditTrailAction(String hashCode) {
    ...
    public static BorhanAuditTrailAction get(String hashCode) {

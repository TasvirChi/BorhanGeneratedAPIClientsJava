 ...
 */
public enum BorhanAdCuePointOrderBy implements BorhanEnumAsString {
    ...
    BorhanAdCuePointOrderBy(String hashCode) {
    ...
    public static BorhanAdCuePointOrderBy get(String hashCode) {

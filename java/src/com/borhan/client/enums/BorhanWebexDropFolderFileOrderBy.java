 ...
 */
public enum BorhanWebexDropFolderFileOrderBy implements BorhanEnumAsString {
    ...
    BorhanWebexDropFolderFileOrderBy(String hashCode) {
    ...
    public static BorhanWebexDropFolderFileOrderBy get(String hashCode) {

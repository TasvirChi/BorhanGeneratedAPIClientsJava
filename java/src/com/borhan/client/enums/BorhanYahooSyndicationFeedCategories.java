 ...
 */
public enum BorhanYahooSyndicationFeedCategories implements BorhanEnumAsString {
    ACTION ("Action"),
    ANIMALS ("Animals"),
    ...
    BorhanYahooSyndicationFeedCategories(String hashCode) {
    ...
    public static BorhanYahooSyndicationFeedCategories get(String hashCode) {

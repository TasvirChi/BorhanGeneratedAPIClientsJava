 ...
 */
public enum BorhanStorageProfileProtocol implements BorhanEnumAsString {
    ...
    BorhanStorageProfileProtocol(String hashCode) {
    ...
    public static BorhanStorageProfileProtocol get(String hashCode) {

 ...
 */
public enum BorhanDropFolderErrorCode implements BorhanEnumAsString {
    ERROR_CONNECT ("1"),
    ERROR_AUTENTICATE ("2"),
    ...
    BorhanDropFolderErrorCode(String hashCode) {
    ...
    public static BorhanDropFolderErrorCode get(String hashCode) {

 ...
 */
public enum BorhanLiveReportExportType implements BorhanEnumAsInt {
    PARTNER_TOTAL_ALL (1),
    ...
    BorhanLiveReportExportType(int hashCode) {
    ...
    public static BorhanLiveReportExportType get(int hashCode) {
        switch(hashCode) {

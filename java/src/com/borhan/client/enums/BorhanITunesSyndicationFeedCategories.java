 ...
 */
public enum BorhanITunesSyndicationFeedCategories implements BorhanEnumAsString {
    ARTS ("Arts"),
    ...
    BorhanITunesSyndicationFeedCategories(String hashCode) {
    ...
    public static BorhanITunesSyndicationFeedCategories get(String hashCode) {

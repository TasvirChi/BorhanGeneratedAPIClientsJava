 ...
 */
public enum BorhanShortLinkOrderBy implements BorhanEnumAsString {
    ...
    BorhanShortLinkOrderBy(String hashCode) {
    ...
    public static BorhanShortLinkOrderBy get(String hashCode) {

 ...
 */
public enum BorhanPartnerOrderBy implements BorhanEnumAsString {
    ...
    BorhanPartnerOrderBy(String hashCode) {
    ...
    public static BorhanPartnerOrderBy get(String hashCode) {

 ...
 */
public enum BorhanDistributionValidationErrorType implements BorhanEnumAsInt {
    CUSTOM_ERROR (0),
    STRING_EMPTY (1),
    STRING_TOO_LONG (2),
    STRING_TOO_SHORT (3),
    ...
    BorhanDistributionValidationErrorType(int hashCode) {
    ...
    public static BorhanDistributionValidationErrorType get(int hashCode) {
        switch(hashCode) {

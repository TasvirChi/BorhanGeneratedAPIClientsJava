 ...
 */
public enum BorhanEventCuePointOrderBy implements BorhanEnumAsString {
    ...
    BorhanEventCuePointOrderBy(String hashCode) {
    ...
    public static BorhanEventCuePointOrderBy get(String hashCode) {
